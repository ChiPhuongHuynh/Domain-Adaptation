...
#ckpt_M = torch.load("artifacts/mnist/mnist_pretrained_ssim.pt", map_location=device)
ckpt_M = torch.load("artifacts/usps/usps_pretrained.pt", map_location=device)
...
results = compare_shared_encoder_alignment(
    encoder_M, decoder_M, loader_M, loader_U,
    device=device,
    n_samples=1000,
